...
<html>
	<head>
		<title>Bakeaholics - My Account</title>
                ...
                <tr>
                  ...
                  <div class="dashbord">
                    <div class="icon-section"> <br />
                      <img src="images/profile.jpg" alt="" width="93" height="96" />
                      <p>&nbsp;</p>
                    </div>
                    <div class="detail-section"> <a href="ViewCustomerProfile.php">My Profile<br> </a> </div>
                  </div>
                  <div class="dashbord dashbord-green">
                    <div class="icon-section"> <br />
                      <img src="images/cart.png" width="93" height="96" />
                      <p>&nbsp;</p>
                    </div>
                    <div class="detail-section"><a href="ShoppingCart.php"> My Cart</a> </div>
                  </div>
                  <div class="dashbord dashbord-blue">
                    ...
                    <div class="detail-section"> <a href="products.php">View All Products</a> </div>
                  </div>
                  <div class="dashbord dashbord-skyblue">
                    <div class="icon-section"> <br />
                      <img src="images/historycart.png" alt="" width="93" height="96" />
                      <p>&nbsp;</p>
                    </div>
                    <div class="detail-section"><a href="OrderHistory.php">Purchase History</a> </div>
                  </div>
                  <div class="dashbord dashbord-red">
                    <div class="icon-section"> <br />
                      <img src="images/track.png" alt="" width="87" height="90" />
                      <p>&nbsp;</p>
                    </div>
                    <div class="detail-section"> <a href="TrackOrder.php">Track My Order</a> </div>
                  </div>
                  <div class="dashbord dashbord-orange">
                    <div class="icon-section"> <br />
                      <img src="images/inquire.png" alt="" width="93" height="96" />
                      <p>&nbsp;</p>
                    </div>
                    <div class="detail-section"><a href="ContactUs.html">Inquiries</a></div>
                  </div>
                </div></td>
                </tr>
              </tbody>
