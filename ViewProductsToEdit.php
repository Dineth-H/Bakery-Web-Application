...
<html>
	<head>
		<title>Bakeaholics - View Added Products</title>
  ...
  <div class="column" style="border:ridge; border-color:darksalmon;">
    <div class="card">
	  <p></p>
      <img src="<?php echo $row["imagePath"]?>"  style=" max-width: 420px; max-height: 260px" >
      <div class="container">
        <h2><?php echo $row["productName"]?></h2>        
        <p><?php echo $row["description"]?></p>
		<p>Price per 1kg : Rs. <?php echo $row["price"]?>.00 </p>
        <p align="center">
            <a href="EditProduct.php?id=<?php echo $row["productID"]; ?>">Update Product Details</a>
        </p>
        <br>
      </div>
    </div>
