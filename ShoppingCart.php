...
<html>
	<head>
		<title>Bakeaholics - My Cart</title>
    ...
    * {
	...
	<body class="contact" id="contact">
                ...
                <div class="row">
                    <div class="col-lg-10 offset-lg-1">
                        <div class="cart_container">
                            <div class="cart_title">Shopping Cart <button class="cart_clear" onclick="clearAll()"> Clear ×</button></div>
                            <div class="cart_items">
                                <ul class="cart_list" id="shopping_cart_items">
                                    
                                    
                                </ul>
                                <h5 style="text-align: center;" id="shopping_cart_empty"> </h5>

                            </div>
                            <div class="order_total">
                                <div class="order_total_content text-md-right">
                                    <div class="order_total_title">Order Total:</div>
                                    <div class="order_total_amount" id="total_shopping_cart">Rs 00.00</div>
                                </div>
                            </div>
                            <div class="cart_buttons" id="shopping_cart_btn"> 
                                </div>
                        </div>
                    </div>
                </div>
        ...
        <div class="s_items" id="s_items_container"></div>
		<!-- Footer -->
			<footer id="footer">
				<div class="container">
					<ul class="icons">
