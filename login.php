...
input[type="submit"].ghost {
	background-color: #ECA1BE;
	border-color: #FFFFFF;
}

form {
	background: linear-gradient(to right, #E68FB0, #EDCAE2);
	display: flex;
	align-items: center;
	justify-content: center;
	flex-direction: column;
...
.overlay {
	...
	background: linear-gradient(to right, #9EC6C3, #1C7194);
...
<div class="container" id="container">
	<div class="form-container sign-up-container">
		<form action="RegistrationHandler.php" method="post">
			...
			<input type="submit" value="Sign Up" onClick="checkPassword()" name="btnSignUp">
	...
	<div class="overlay-container">
		<div class="overlay">
			...
			<div class="overlay-panel overlay-right">
				<h1>Hello, Cakeaholic!</h1>
				<p>Not yet Registered? Enter your personal details and register with us</p>
